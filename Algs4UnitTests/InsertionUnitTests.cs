//-----------------------------------------------------------------------
// <copyright file="InsertionUnitTests.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4UnitTests
{
   ...
   /// <summary>
   /// Unit Tests for the Insertion sort class.
   /// </summary>
   [TestClass]
   public class InsertionUnitTests
   {
      ...
      /// </summary>
      [TestMethod]
      public void InsertionTiny()
      {
         string[] expectedResult = { "A", "E", "E", "L", "M", "O", "P", "R", "S", "T", "X" };
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\tiny.txt", Insertion.Instance);
      ...
      public void InsertionWords3()
      {
         ...
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\words3.txt", Insertion.Instance);
         for (int i = 0; actualResult.Length > i && expectedResult.Length > i; i++)
         {
            Assert.AreEqual(expectedResult[i], actualResult[i]);
         }
