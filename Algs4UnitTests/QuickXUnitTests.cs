//-----------------------------------------------------------------------
// <copyright file="QuickXUnitTests.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4UnitTests
{
   ...
   /// <summary>
   /// Unit Tests for the QuickX sort class.
   /// </summary>
   [TestClass]
   public class QuickXUnitTests
   {
      /// <summary>
      /// Sort a small text file.
      /// </summary>
      [TestMethod]
      public void QuickXTiny()
      {
         string[] expectedResult = { "A", "E", "E", "L", "M", "O", "P", "R", "S", "T", "X" };
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\tiny.txt", QuickX.Instance);
      ...
      public void QuickXWords3()
      {
         ...
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\words3.txt", QuickX.Instance);
         for (int i = 0; actualResult.Length > i && expectedResult.Length > i; i++)
         {
            Assert.AreEqual(expectedResult[i], actualResult[i]);
         }
