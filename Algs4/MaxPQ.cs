//-----------------------------------------------------------------------
// <copyright file="MaxPQ.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4
{
   ...
   public class MaxPQ<T> : PQCollection<T>
   {
      #region Constructors
      /// <summary>
      /// Initializes a new instance of the <see cref="MaxPQ{T}"/> class with the given initial capacity.
      /// </summary>
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="MaxPQ{T}"/> class with an initial capacity of 1 item.
      /// </summary>
      public MaxPQ()
         : base(1)
      {
      ...
      /// <exception cref="ArgumentOutOfRangeException">Thrown when the specified initial capacity is <code>int.MaxValue</code></exception>
      public MaxPQ(int initialCapacity, IComparer<T> comparator) 
         : base(initialCapacity, comparator)
      {
      }

      /// <summary>
      ///  Initializes a new instance of the <see cref="MaxPQ{T}"/> class with the given comparator and capacity for 1 element.
      /// </summary>
      /// <param name="comparator">The order in which to compare the keys.</param>
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="MaxPQ{T}"/> class from an array of keys.
      ...
      {
         MaxPQ<T> copy = new MaxPQ<T>(this.Count);
      ...
      /// <summary>
      /// Get a largest key on the priority queue.
      /// </summary>
      /// <returns>A largest key on the priority queue.</returns>
      /// <exception cref="NoSuchElementException">Thrown if the priority queue is empty.</exception>
