//-----------------------------------------------------------------------
// <copyright file="HeapUnitTests.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4UnitTests
{
   ...
   /// <summary>
   /// Unit Tests for the Heap sort class.
   /// </summary>
   [TestClass]
   public class HeapUnitTests
   {
      ...
      /// </summary>
      [TestMethod]
      public void HeapTiny()
      {
         string[] expectedResult = { "A", "E", "E", "L", "M", "O", "P", "R", "S", "T", "X" };
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\tiny.txt", Heap.Instance);
      ...
      public void HeapWords3()
      {
         ...
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\words3.txt", Heap.Instance);
         for (int i = 0; actualResult.Length > i && expectedResult.Length > i; i++)
         {
            Assert.AreEqual(expectedResult[i], actualResult[i]);
         }
