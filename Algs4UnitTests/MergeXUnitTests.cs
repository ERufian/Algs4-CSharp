//-----------------------------------------------------------------------
// <copyright file="MergeXUnitTests.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4UnitTests
{
   ...
   /// <summary>
   /// Unit Tests for the MergeX sort class.
   /// </summary>
   [TestClass]
   public class MergeXUnitTests
   {
      /// <summary>
      /// Sort a small text file.
      /// </summary>
      [TestMethod]
      public void MergeXTiny()
      {
         string[] expectedResult = { "A", "E", "E", "L", "M", "O", "P", "R", "S", "T", "X" };
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\tiny.txt", MergeX.Instance);
      ...
      public void MergeXWords3()
      {
         ...
         string[] actualResult = CommonSortUnitTests.SortCommon("Algs4-Data\\words3.txt", MergeX.Instance);
         for (int i = 0; actualResult.Length > i; i++)
         {
            Assert.AreEqual(expectedResult[i], actualResult[i]);
         }
