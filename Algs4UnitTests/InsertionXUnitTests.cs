//-----------------------------------------------------------------------
// <copyright file="InsertionXUnitTests.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4UnitTests
{
   ...
   /// <summary>
   /// Unit Tests for the InsertionX sort class.
   /// </summary>
   [TestClass]
   public class InsertionXUnitTests
   {
      /// <summary>
