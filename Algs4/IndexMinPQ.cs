//-----------------------------------------------------------------------
// <copyright file="IndexMinPQ.cs" company="Eusebio Rufian-Zilbermann">
...
namespace Algs4
{
   ...
   /// <summary>
   /// The <tt>IndexMinPQ</tt> class represents a priority queue 
   ...
   public class IndexMinPQ<T> : IndexPQDictionary<T>
   {
      #region Constructors
      /// <summary>
      /// Initializes a new instance of the <see cref="IndexMinPQ{T}"/> class.
      /// </summary>
      ...
      public IndexMinPQ(int maxCount, IComparer<T> comparator)
      ...
      {
         IndexMinPQ<T> copy = new IndexMinPQ<T>(this.Count);
